...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        if ($user && $user->role === 'student') {
            $events = \App\Models\Event::where('status', 'published')->latest()->get();
            $myRegistrations = \App\Models\Registration::where('user_id', $user->id)->with('event', 'certificate')->latest()->get();
