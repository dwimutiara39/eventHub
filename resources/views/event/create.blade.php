        ...
        <form action="{{ route('event.store') }}" method="post" enctype="multipart/form-data" class="form">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    @enderror
                    <img src="{{ asset('niceadmin/img/noprofil.png') }}" alt="Banner" class="w-100 rounded mt-2"
                        id="preview" style="max-height: 200px; object-fit: cover;">
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control @error('capacity') is-invalid @enderror" type="number"
                                id="capacity" name="capacity" required min="1" value="{{ old('capacity') }}">
                            @error('capacity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
