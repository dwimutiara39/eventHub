...
<head>
    ...
    <meta content="Dwi Mutiara" name="author">
...
<body>
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications" style="min-width: 300px; max-height: 400px; overflow-y: auto;">
                        <li class="dropdown-header">
                            Anda memiliki {{ $unreadNotifications->count() }} notifikasi baru
                        </li>
                        <li><hr class="dropdown-divider"></li>

                        @forelse(Auth::user()->notifications()->latest()->take(5)->get() as $notification)
                            <li class="notification-item p-3 {{ $notification->is_read ? 'bg-light' : '' }}">
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @if(!$notification->is_read)
                                            <form action="{{ route('notification.read', $notification) }}" method="POST" class="d-inline">
                                                @csrf @method('PUT')
                                                <button type="submit" class="btn btn-link btn-sm p-0 text-decoration-none">Tandai dibaca</button>
                                            </form>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <li><hr class="dropdown-divider"></li>
                        @empty
                            <li class="notification-item p-3 text-center text-muted">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @if (in_array(Auth::user()->role, ['superadmin', 'admin']))
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('event.*') ? '' : 'collapsed' }}"
