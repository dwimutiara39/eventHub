<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('organization.store') }}" method="post" enctype="multipart/form-data" class="form">
            @csrf
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-3">
                    ...
                    @enderror
                    <img src="{{ asset('niceadmin/img/noprofil.png') }}" alt="Logo" class="w-100 rounded mt-2"
                        id="preview">
                </div>
