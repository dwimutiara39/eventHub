                ...
                <div class="col-md-9">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-default @error('role') is-invalid  @enderror" id="role"
                            ...
                            <option value="admin" @selected(old('role', $user->role) == 'admin')>Admin/Panitia</option>
                    ...
                    <div class="mb-3">
                        <label for="nim" class="form-label">NIM (Hanya untuk Student)</label>
                        <input class="form-control @error('nim') is-invalid  @enderror" type="text" id="nim"
